 ...
 * cron jobs, workflows, sub-agents, and external automation.
...
data class AgentRun(
     ...
     * run id; external_automation: request id (or a generated id).
     */
...
/**
 * Discriminator for the four autonomous paths. Stored as [AgentRunKind.wire] in the
 * `kind` column.
 */
