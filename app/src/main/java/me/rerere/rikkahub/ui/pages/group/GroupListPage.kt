...
fun GroupListPage(vm: GroupVM = koinViewModel()) {
    ...
    var editTarget by remember { mutableStateOf<GroupEntity?>(null) }
    var deleteTarget by remember { mutableStateOf<GroupEntity?>(null) }

    Scaffold(
        topBar = {
            LargeFlexibleTopAppBar(
                title = { Text(stringResource(R.string.roleplay_title)) },
    ...
    if (showCreateDialog) {
        EditGroupDialog(
            title = stringResource(R.string.group_page_create),
            initialName = "",
    ...
    editTarget?.let { group ->
        EditGroupDialog(
            title = stringResource(R.string.group_page_rename),
            initialName = group.name,
            onDismiss = { editTarget = null },
            onConfirm = { name ->
                vm.rename(group.id, name)
                editTarget = null
            },
        )
    }
    ...
    RikkaConfirmDialog(
        ...
        title = stringResource(R.string.group_page_delete),
        ...
        Text(stringResource(R.string.group_page_delete_confirm))
    }
}
...
private fun EmptyGroupState() {
    Column(
        ...
        Text(
            text = stringResource(R.string.group_page_empty),
            style = MaterialTheme.typography.bodyLarge,
            color = MaterialTheme.colorScheme.onSurfaceVariant,
        )
        Text(
            text = stringResource(R.string.group_page_empty_desc),
